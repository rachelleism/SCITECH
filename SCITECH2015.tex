...
\begin{figure}
\centering{}\subfloat[St=0.05]{\includegraphics[width=2.9in]{M09St005qcritphase0106AB}
}\subfloat[St=0.15]{\includegraphics[width=2.9in]{M09St015qcritphase0106AB}}

\subfloat[St=0.25]{\includegraphics[width=2.9in]{M09St025qcritphase0106AB}
...
\begin{figure}
\centering{}\subfloat[Phase averaged point probes on the first array for St=0.05 and 0.25]{\includegraphics[width=3.25in]{phaseaxial}\label{pphase24}
