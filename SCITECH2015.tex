...
\begin{figure}
\centering{}\subfloat[Phase averaged point probes on the first array for St=0.05 and 0.25]{\includegraphics[width=3in]{M09phaseSt025}\label{pphase24}
}\subfloat[Two-point correlations of x/D=2 to x/D=4 for each excitation Strouhal number]{\includegraphics[width=3in]{M09M13crosscorrSt025}}\label{corr24}
